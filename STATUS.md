...
| ESM bundle (as a consumer ships it) | **6.18 kB** min+gzip (budget 7 kB) |
| Single-component import (`Button`) | **622 B** min+gzip (budget 1.5 kB) |
| Stylesheet | **3.76 kB** min+gzip (budget 8 kB) |
